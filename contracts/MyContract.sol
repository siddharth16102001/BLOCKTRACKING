...
contract MyContract {
    ...
    event ShipmentDelievered(address indexed sender, address indexed receiver, uint256 deliveryTime);
    ...
    public {
        ...
        shipment.status = ShipmentStatus.DELIVERED;
         ...
         emit ShipmentDelievered(_sender, _receiver, shipment.deliveryTime);
    ...
    function getShiomentCount(address _sender) public view returns (uint256) {
